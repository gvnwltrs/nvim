...
vim.api.nvim_set_keymap('n', '<F8>', ':bprev<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<F9>', ':bnext<CR>', {noremap = true})
vim.api.nvim_set_keymap('n', '<F12>', ':BufDel<CR>', {noremap = true})
